...
<head>
    ...
    <title><?php echo htmlspecialchars($orri_titulua . ' - Unanue Upategiak' ?? 'Unanue Upategiak'); ?></title>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 align-items-center">
                    ...
                    <?php 
                        ...
                        if (isset($_SESSION['is_admin']) && $_SESSION['is_admin']) {
                            echo '<li class="nav-item me-2"><a class="btn btn-light" href="' . BASE_URL . 'langile-zerrenda.php">Langile Zerrenda</a></li>';
                            echo '<li class="nav-item me-2"><a class="btn btn-light" href="' . BASE_URL . 'langilea-sortu.php">Langilea Sortu</a></li>';
                            echo '<li class="nav-item me-2"><a class="btn btn-light" href="' . BASE_URL . 'oharrak-kudeatu.php">Oharrak Kudeatu</a></li>';
                        }
                    ?>
                </ul>
                <div class="d-flex align-items-center">
                    <?php if (isset($_SESSION['username'])): ?>
                        <span class="navbar-text me-3">Kaixo, <?php echo htmlspecialchars($_SESSION['username']); ?></span>
